...
public class PlayerController : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other) 
	{
		...
		if (other.gameObject.CompareTag("CheckPlane"))
		{
			...
			if (count >= 11)
			{
				...
				winTextObject.text = "Good job! Thank you for playing!:)\n Game will restart in 5 seconds...";
			}
            else
            {
				winTextObject.text = "Good, But you didn't collect all the items yet!\n Game will restart in 5 seconds...";
			}
			finished = true;
			StartCoroutine(Wait()); 
		}
	...
	void SetCountText()
	{
		...
		countText.text = "Remaining Collectibles: " + (11 - count).ToString ();
